...
module Meta
  class Datum
    ...
    embeds_many :meta_tags, class_name: "Meta::Tag"
    embeds_many :meta_references, class_name: "Meta::Reference" #mongo# TODO merge meta_tags into meta_references
    ...
    def to_s
      if not meta_tags.blank?
        meta_tags.collect(&:to_s).join(', ')
